...
/* harmony default export */ var editorvue_type_script_lang_js_ = ({
  ...
  methods: {
    async getArticleDetail() {
      const {
        data
      } = await Object(api_article["g" /* getArticle */])(this.$route.params.slug);
    ...
    async onPublishArticle() {
      ...
      try {
        ...
        const {
          data
        } = this.isEditor ? await Object(api_article["a" /* addArticle */])(params) : await Object(api_article["k" /* updateArticle */])(this.$route.params.slug, params);
        this.$router.push({
          name: 'article',
          params: {
